...
![Membrane topologies](images/membrane_topologies.svg "Figure - Membrane topologies") - topologies of proteins associated with the Gram-negative inner and outer membranes (a), and the Gram-positive plasma membrane and cell wall (b).
