...
def annotate(params, proteins, \
             ...
             url = "https://raw.github.com/boscoh/inmembrane/master/\
  ...
  #       since the LipoP webservice will take a maximum of
  #       2000 sequences at a time
  if len(proteins) > 2000:
    log_stderr("# ERROR: LipoP(web): currently only works with < 2000 sequences.")
    return
